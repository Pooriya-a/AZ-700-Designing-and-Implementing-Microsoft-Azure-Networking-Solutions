...
8. In the **Add subnet** pane, provide a subnet name of **myBackendSubnet**, and a subnet address range of **10.1.1.0/24**.
...
3. Deploy the following ARM templates to create the VMs needed for this exercise. Use this path "Allfiles\Exercises\M04".
